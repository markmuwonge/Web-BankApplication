...
<%
	try
	{
		if ((Integer) session.getAttribute("role") == 2)
		{
			...
			if (error == true)
			{
				out.println("Return <a href='http://localhost:8080/Bank/admin.jsp'>Admin</a>");
			}
			else
			{
				try
				{
					...
					out.println("<center>Update successful return to <a href='http://localhost:8080/Bank/admin.jsp'>Admin</a></center>");
				}
				catch (Exception e)
				{
