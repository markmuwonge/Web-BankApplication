	...
	try
	{
		...
		if (((Integer) session.getAttribute("role") == 1) && username.equals(request.getParameter("acNo")))
		{
			String headContent = "<head>" + 
								"<title>Deposit | Mark's Bank </title>" + 
			...
			out.println("<center>");
				...
				out.println("<div class='box3'>");
					out.println("<center><h2>Deposit</h2></center>");
						out.println("<form action='http://localhost:8080/Bank/deposit.jsp' method='post' id='deposit'>");
						out.println("<center>");
						out.println("<input name='depositamount'  placeholder='Deposit Amount' class='formTextField'>");
						...
						out.println("<a href='#' onclick=document.getElementById('deposit').submit();>");
